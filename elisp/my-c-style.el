;;; my-c-style.el --- My C/C++ style for c-mode

;; Keywords: c, tools

;; my-c-style.el is Copyright (C) 2008 Google Inc. All Rights Reserved.
;;
...
;; Provides the my C/C++ coding style. You may wish to add
;; `my-set-c-style' to your `c-mode-common-hook' after requiring this
;; file. For example:
;;
...
;;
;;    (add-hook 'c-mode-common-hook 'my-make-newline-indent)
